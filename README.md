...
**LeaderBoard** is a project meant to allow users to add their name and scores  while they are desplayed on the App.
...
```sh
  cd my-folder
  git clone git@github.com:MPDADDY/Leaderboard.git
```
...
Feel free to check the [issues page](https://github.com/MPDADDY/leaderboad/issues).
